...
// Інтерфейс пропсів має бути ідентичним до вашого справжнього компонента,
// щоб уникнути помилок TypeScript у місцях його виклику.
interface ProductSliderProps {
  title: string;
}

/**
 * Це компонент-заглушка для тестування продуктивності.
 * Він приймає ті ж пропси, що і справжній слайдер, але нічого не відображає.
 */
export default function ProductSlider({ title }: ProductSliderProps) {
  // Повертаємо null, щоб компонент нічого не рендерив
  return null;
}
